...
| Membro | Papel |
|---|---|
| **Yan Matheus** | Facilitador — responsável por guiar e conduzir as atividades ao longo da etapa de Mapping. |
| **Arthur Evangelista** | Facilitador — responsável por guiar e conduzir as atividades ao longo da etapa de Mapping. |
...
| ------ | ---------- | --------------------- | ------------------------------------------------ | ------- |
| 1.0    | 30/03/2026 | Criação do documento e adição dos artefatos produzidos durante a etapa de mappping | [Arthur Evangelista](https://github.com/arthurevg) |         |
| 1.1    | 31/03/2026 | Adição das referências do Miro e do Microsoft Teams |  [Arthur Evangelista](https://github.com/arthurevg) |         |